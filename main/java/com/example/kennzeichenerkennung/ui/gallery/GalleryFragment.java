...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        String bemerk = "";
        if (!Objects.equals(currentKennzeichen.BemerkungenGeben(), "---") && !Objects.equals(currentKennzeichen.BemerkungenGeben(), "")) {
            bemerk = "Folgende Bemerkung ist noch hinterlegt: " + currentKennzeichen.BemerkungenGeben();
        }
        ...
        binding.textOftheday.setText("Heute, am " + currentDate + ", dem " + dayOfYear + ".Tag diesen Jahres ist das Kennzeichen-Kürzel des Tages " + currentKennzeichen.OertskuerzelGeben() + ". " + currentKennzeichen.OertskuerzelGeben() + " leitet sich von " + currentKennzeichen.OrtGeben() + " ab und gehört zur Stadt bzw. zum Kreis " + currentKennzeichen.StadtKreisGeben() + ".\n" + currentKennzeichen.StadtKreisGeben() + " liegt in Deutschland im Bundesland " + currentKennzeichen.BundeslandGeben() + ".\n" + bemerk);
